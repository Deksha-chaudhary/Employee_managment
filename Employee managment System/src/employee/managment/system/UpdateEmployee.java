...
public class UpdateEmployee extends JFrame implements ActionListener {
	...
	JTextField tfeducation,tffname,tfsalary,tfdesignation,tfaddress,tfphone,tfemail,tfaadhar;
	JButton add,back;
	JLabel lblempId;
	String empId;
	...
	try {
		Conn c=new Conn();
		String query="select * from employee01 where empId= '"+empId+"'";
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==add) {
			...
			try {
				Conn conn=new Conn();
                String query = "update employee01 set fname = '"+fname+"', salary = '"+salary+"', address = '"+address+"', phone = '"+phone+"', email =  '"+email+"', education = '"+education+"', designation = '"+designation+"' where empId = '"+empId+"'";
